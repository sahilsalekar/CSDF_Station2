...
def run(client, pallet_row, pallet_col, exp_id):
    print(f"Running 1Station4 with palletindex {sta_num} {pallet_row} {pallet_col}")
    ...
    try:
        ...
        if reply == "0":
            ...
            if reply == "0":
                ...
                client.SendCommand(f"movej 3 1021.847 -1.398 124.000 179.77 103.064 {axis_6}")
                reply = client.SendCommand("waitforeom") 
                ...
                if reply == "0 0":
                    ...
                    client.SendCommand(f"movej 3 1017.83 -2.902 180.537 178.063 103.542 {axis_6}")
                    reply = client.SendCommand("waitforeom")
